...
if %errorlevel%==0 (
    ...
    g++ -std=c++17 -Wall -Wextra -O2 -mwindows -o core.exe main.cpp persistence.cpp -luser32 -lshell32
    if errorlevel 1 (
...
if %errorlevel%==0 (
    ...
    cl /nologo /EHsc /std:c++17 main.cpp persistence.cpp /link /SUBSYSTEM:WINDOWS user32.lib shell32.lib /OUT:core.exe
    if errorlevel 1 (
